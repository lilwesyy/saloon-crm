    ...
    <div class="flex flex-col h-full">
      ...
      <nav class="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
        ...
        <router-link
          ...
          class="flex items-center px-2 py-2 text-sm font-medium rounded-md transition-colors text-gray-600 hover:bg-gray-50 hover:text-gray-900"
          active-class="!bg-purple-100 !text-purple-900"
          exact-active-class="!bg-purple-100 !text-purple-900"
        >
...
// Gestisce il click sui link di navigazione per chiudere la sidebar su mobile/tablet
const handleNavClick = () => {
  // Chiude la sidebar solo su dispositivi mobile/tablet (non desktop)
