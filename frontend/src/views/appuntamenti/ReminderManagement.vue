<template>
  <div class="space-y-6">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
      <div>
        <h1 class="text-2xl font-bold text-gray-900">Gestione Reminder</h1>
        <p class="mt-2 text-sm text-gray-700">Gestisci i reminder automatici per gli appuntamenti</p>
      </div>
      <div class="mt-4 sm:mt-0 flex space-x-3">
        <button
          @click="refreshStatus"
          class="inline-flex items-center gap-2 bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition-colors font-medium"
          :disabled="loading"
        >
        ...
        <button
          @click="testReminders"
          class="inline-flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors font-medium"
          :disabled="loading"
        >
    ...
    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <div class="bg-white overflow-hidden shadow rounded-lg">
        ...
        <div class="bg-gray-50 px-5 py-3">
          <div class="text-sm">
            <span class="font-medium" :class="schedulerStatus.isRunning ? 'text-green-700' : 'text-red-700'">
              {{ schedulerStatus.isRunning ? 'Sistema operativo' : 'Sistema fermo' }}
            </span>
          </div>
        </div>
      </div>
    ...
    <div class="bg-white shadow rounded-lg">
      <div class="px-4 py-5 sm:p-6">
        <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Controllo Scheduler</h3>
        <div class="flex flex-col sm:flex-row gap-3">
          <button
            @click="startScheduler"
            :disabled="schedulerStatus.isRunning || loading"
            class="inline-flex items-center gap-2 bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors font-medium"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
          ...
          <button
            @click="stopScheduler"
            :disabled="!schedulerStatus.isRunning || loading"
            class="inline-flex items-center gap-2 bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 disabled:bg-gray-400 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition-colors font-medium"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
    ...
    <div class="bg-white shadow rounded-lg">
      <div class="px-4 py-5 sm:p-6">
        <h3 class="text-lg leading-6 font-medium text-gray-900 mb-6">Configurazione Reminder</h3>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <!-- Reminder 24h -->
          <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between mb-3">
              <h4 class="font-semibold text-gray-900">24 Ore Prima</h4>
            ...
            <button
              ...
              class="inline-flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
              :disabled="loading"
            >
          ...
          <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between mb-3">
              <h4 class="font-semibold text-gray-900">2 Ore Prima</h4>
              <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                Attivo
              </span>
            </div>
          ...
          <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between mb-3">
              <h4 class="font-semibold text-gray-900">30 Minuti Prima</h4>
              <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                Attivo
              </span>
            </div>
    ...
    <div class="bg-white shadow rounded-lg">
      <div class="px-4 py-5 sm:p-6">
        <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Log Attività</h3>
